...
import com.example.social_interaction.dto.DenormalizeEvent;
...
public class ProfileEventListener {
    ...
    @KafkaListener(
            topics = "profile-interaction-events"
    )
    public void consume(DenormalizeEvent event) {
        ...
        denormalizeService.denormalizeAll(
                new DenormalizeDto(event.aggregateId(),event.payload().avatar())
        );
